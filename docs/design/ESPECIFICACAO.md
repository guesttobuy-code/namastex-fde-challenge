...
| `sender_role` | quem escreveu — lista fechada (I-17, `dominio/CONTRACT.md`): `agente` (padrão, texto determinístico/fixo) · `ia` (resposta orientada de verdade, #58) · `corretor` (atendimento humano, #86) | sim (default `agente`) |
